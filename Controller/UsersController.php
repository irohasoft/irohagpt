...
class UsersController extends AppController
{
	...
	public function admin_edit($user_id = null)
	{
		...
		$this->set(compact('groups', 'username'));
	}
	 ...
	 * ユーザのチャット履歴のクリア
	 *
	 * @param int $user_id チャット履歴をクリアするユーザのID
	 */
	public function admin_clear($user_id)
	{
		$this->request->allowMethod('post', 'delete');
		$this->User->deleteUserChats($user_id);
		$this->Flash->success(__('チャット履歴を削除しました'));
